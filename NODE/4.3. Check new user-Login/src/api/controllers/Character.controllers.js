...
/**UPDATE
 * en le custom body customizo lo que quiero o no cambiar
 * 
 * en el caso del body, me mando la funcion enumOk (en utils) lo que he recibido por el body-- > en caso de poner algo que no se corresponda con el enumOK, ponemos en genero lo que teniamos antes
 * el metodo update no comprueba lo que hay en el emun de gender, por eso tengo que crear una funcion que lo haga
 */

/**DELETE: hay que borrar el personaje en si y en la lista de favoritos del usuario
 * busco el personaje por id y si lo encuentra lo borra
 * vuelvo a buscarlo para ver si sigue existiendo y no se ha borrado
 * UPDATEMANY()--> actualiza todos los datos que incluyan una cierta caracteristica (en toda la coleccion de datos, busca en todos los objetos a traves de una clave)
 */
...
module.exports = {create, getAll, getById, getByName, update, deleteCharacter, toggleLikeCharacter}